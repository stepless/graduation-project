      ...
      <div class="login-box login-box-radius">
        ...
        <el-form ref="userForm" :model="userForm" :rules="rules">
          ...
          <el-form-item class="fromItem" prop="password">
            ...
            <p class="goRegister"><a href="/register">没有账号<i class="iconfont icon-jiantou_xiangyouliangci"></i></a></p>
          </el-form-item>
          <el-form-item size="small" class="login-button">
            <el-button class="fromButton" type="primary" @click="toLogin('userForm')">登录</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
      ...
      login(this.userForm).then((res)=>{
        if(res.data.success){
            for (let index in res.data.data) {
              localStorage.setItem(index, res.data.data[index]);
            }  
            this.$router.push('/');
